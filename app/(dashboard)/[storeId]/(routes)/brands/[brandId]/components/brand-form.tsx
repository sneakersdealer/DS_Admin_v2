...
export const BrandForm: React.FC<BrandFormProps> = ({
    ...
    const headDescription = initialData ? "Edit a Brand" : "Add a new Brand";
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input disabled={loading} type={'textarea'} className='min-h-[170px]' placeholder="Brand description" {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )} />
